  ...
  return (
    <>
      <div className='container'>
        ...
        <a
          className='spacing-text'
          href='https://forms.gov.il/globaldata/getsequence/gethtmlform.aspx?formType=volunteer@pmo.gov.il&Amuta=51'
        >{`לינק לטופס באתר הרשות`}</a>
        ...
        {lockType === adminInterfaceEnums.adminInterfacePartial && (
          <button className='button-styling' onClick={() => {}}>{`סגור`}</button>
        )}
      </div>
    </>
  )
