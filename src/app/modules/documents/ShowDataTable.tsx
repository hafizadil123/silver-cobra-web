          ...
          >
            ...
            <thead>
              <tr className='fw-bolder text-muted'>
                <TableHeadView className=' ' text={inputLabels.documentType} />
                <TableHeadView className=' ' text={inputLabels.description} />
                <TableHeadView className=' ' text={inputLabels.link} />
                <TableHeadView className='' text={inputLabels.isApproved} />
                <TableHeadView className='' text={inputLabels.isDeclined} />
                <TableHeadView className=' ' text={inputLabels.uploaded} />
                <TableHeadView className=' ' text={inputLabels.actionDate} />
              </tr>
            </thead>
            {/* end::Table head */}
            {/* begin::Table body */}
                ...
                return (
                  <tr>
                    ...
                    <DataView
                      dataText={
                        hasLink ? (
                          <Link style={{cursor: 'pointer'}} to={`${showDocumentEndpoint}/${code}`}>
                            {code}
                          </Link>
                        ) : (
                          ''
...
const DataView = (props: any) => {
  ...
  return (
    <>
      {isCheckbox ? (
        <td style={{padding: '5px 0px', whiteSpace: 'nowrap'}} className={`${className}`}>
          {' '}
          <input type='checkbox' className='form-control-sm' checked={dataText} disabled />
        </td>
      ) : (
        <td style={{whiteSpace: 'nowrap', padding: '5px 5px'}} className={`${className}`}>
          {dataText}
        </td>
      )}
    </>
